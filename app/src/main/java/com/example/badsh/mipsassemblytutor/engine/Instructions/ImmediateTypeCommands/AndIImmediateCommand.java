...
public class AndIImmediateCommand extends MipsImmediateCommand {

    public AndIImmediateCommand() {
        FUNCTION_STRING = "andi";
        FUNCTION_OPCODE = "001100";
        // Generates registers
    ...
    private void buildRegisterMachineInstruction() {
        StringBuilder sb = new StringBuilder()
                ...
                .append(EngineUtils.leftPadBinaryString(16, String.valueOf(IMMEDIATE_VALUE)));
